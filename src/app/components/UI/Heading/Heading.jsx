...
return(
    <>
    {headingStyle === 'h1' && ( 
    <h1 className={ className  + " max-md:text-[48px] text-[120px] font-black leading-[1.26895833] uppercase font-mulish max-sm:text-[40px]"}>{children}{text}</h1>
    )}
    {headingStyle === 'h2' && (
    <h2 className={ className  + " text-[36px] max-xl:text-[30px] max-2xl:text-[56px] max-sm:text-[28px] max-xs:text-[24px] font-black leading-[1.25500] uppercase font-mulish"}>{children}{text}</h2>
     ...
     {headingStyle === 'h3' && (
    <h3 className={ className  + " text-[36px] max-xl:text-[30px] max-2xl:text-[32px]  max-sm:text-[24px]  max-xs:text-[18px] font-black leading-[1.26895833] uppercase font-mulish"}>{children}{text}</h3>
    )}
     {headingStyle === 'h4' && (
    ...
    <div className={ className   + " text-[60px]  max-xl:text-[30px] max-2xl:text-[56px] max-sm:text-[28px] max-xs:text-[24px] font-black leading-[1.25500] uppercase font-mulish"}>{children}{text}</div>
    )}
         {headingStyle === 'h3Class' && ( 
    <div className={ className  + " text-[36px] max-xl:text-[30px] max-2xl:text-[32px]  max-sm:text-[24px]  max-xs:text-[18px] font-black leading-[1.26895833] uppercase font-mulish"}>{children}{text}</div>
    )}
         {headingStyle === 'h4Class' && ( 
    <div className={ className  + " text-[36px] max-xl:text-[30px] max-2xl:text-[32px] max-sm:text-[18px]  max-xs:text-[18px] font-bold leading-[1.25500] font-mulish"}>{children}{text}</div>
    )}
