...
const Legal = () => {
    const {formActive,setFormActive , formActiveTerm, setFormActiveTerm} = useThemeConfig();
    ...
    <Wrapper className="relative pt-5 pb-8  max-smlg:max-w-full">
      <Wrapper className="flex-1  sticky top-[52px] bg-white py-3  max-tab:top-[66px]">
        <Container className=" flex gap-x-[30px] justify-between flex-col gap-y-4">
          {" "}
          <Heading headingStyle="h2" className="!text-[24px] flex items-center justify-between gap-4">
            Terms & Conditions {formActiveTerm && (<Button type='button' color='orange' btnType='solid' additionalCss='!text-sm !w-auto flex items-center gap-2 group !py-1 !px-3 max-sm:!px-1' event={setFormTerm}> 
<svg height="24" viewBox="0 -960 960 960" width="24"><path fill='#fff' className='group-hover:fill-[#DA4615] transition-all duration-300 ' d="M359-242 120-481l239-239 43 43-166 166h604v60H236l166 166-43 43Z"/></svg> Go back</Button>) }
          </Heading>
        </Container>
      </Wrapper>
    ...
    <Wrapper className="relative pt-5 pb-8  bg-whtie max-smlg:max-w-full  bg-c-green-100">
      <Wrapper className="flex-1  sticky top-[52px] bg-c-green-100 py-3 max-tab:top-[66px]">
        <Container>
          <Heading headingStyle="h2" className="!text-[24px] flex items-center justify-between gap-4">
            Privacy Policy  {formActive && (<Button type='button' color='orange' btnType='solid' additionalCss=' !py-1 !px-3 !text-sm !w-auto flex items-center gap-2 group' event={setForm}> 
<svg height="24" viewBox="0 -960 960 960" width="24"><path fill='#fff' className='group-hover:!fill-[#DA4615] transition-all duration-300 ' d="M359-242 120-481l239-239 43 43-166 166h604v60H236l166 166-43 43Z"/></svg> Go back</Button>) }
          </Heading>
        </Container>
      </Wrapper>
